...
public class ModBlocks
{
    ...
    public static final DeferredBlock<Block> HORIZONTAL_UNAFFECTED_COPPER_BARS = BLOCKS.register("horizontal_copper_bars", () -> createOxidizingBarsBlock(WeatheringCopper.WeatherState.UNAFFECTED, MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.METAL, BarsType.OXIDIZING));
    public static final DeferredBlock<Block> HORIZONTAL_EXPOSED_COPPER_BARS = BLOCKS.register("horizontal_exposed_copper_bars", () -> createOxidizingBarsBlock(WeatheringCopper.WeatherState.EXPOSED, MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.METAL, BarsType.OXIDIZING));
    public static final DeferredBlock<Block> HORIZONTAL_WEATHERED_COPPER_BARS = BLOCKS.register("horizontal_weathered_copper_bars", () -> createOxidizingBarsBlock(WeatheringCopper.WeatherState.WEATHERED, MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.METAL, BarsType.OXIDIZING));
    public static final DeferredBlock<Block> HORIZONTAL_OXIDIZED_COPPER_BARS = BLOCKS.register("horizontal_oxidized_copper_bars", () -> createOxidizingBarsBlock(WeatheringCopper.WeatherState.OXIDIZED, MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.METAL, BarsType.OXIDIZING));

    public static final DeferredBlock<Block> WAXED_HORIZONTAL_UNAFFECTED_COPPER_BARS = BLOCKS.register("waxed_horizontal_copper_bars", () -> createMetallicBarsBlock(MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.METAL, BarsType.WAXED));
    public static final DeferredBlock<Block> WAXED_HORIZONTAL_EXPOSED_COPPER_BARS = BLOCKS.register("waxed_horizontal_exposed_copper_bars", () -> createMetallicBarsBlock(MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.METAL, BarsType.WAXED));
    public static final DeferredBlock<Block> WAXED_HORIZONTAL_WEATHERED_COPPER_BARS = BLOCKS.register("waxed_horizontal_weathered_copper_bars", () -> createMetallicBarsBlock(MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.METAL, BarsType.WAXED));
    public static final DeferredBlock<Block> WAXED_HORIZONTAL_OXIDIZED_COPPER_BARS = BLOCKS.register("waxed_horizontal_oxidized_copper_bars", () -> createMetallicBarsBlock(MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.METAL, BarsType.WAXED));
    ...
    public static final DeferredBlock<Block> HORIZONTAL_CROSSED_UNAFFECTED_COPPER_BARS = BLOCKS.register("horizontal_crossed_copper_bars", () -> createOxidizingBarsBlock(WeatheringCopper.WeatherState.UNAFFECTED, MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.METAL, BarsType.OXIDIZING));
    public static final DeferredBlock<Block> HORIZONTAL_CROSSED_EXPOSED_COPPER_BARS = BLOCKS.register("horizontal_crossed_exposed_copper_bars", () -> createOxidizingBarsBlock(WeatheringCopper.WeatherState.EXPOSED, MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.METAL, BarsType.OXIDIZING));
    public static final DeferredBlock<Block> HORIZONTAL_CROSSED_WEATHERED_COPPER_BARS = BLOCKS.register("horizontal_crossed_weathered_copper_bars", () -> createOxidizingBarsBlock(WeatheringCopper.WeatherState.WEATHERED, MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.METAL, BarsType.OXIDIZING));
    public static final DeferredBlock<Block> HORIZONTAL_CROSSED_OXIDIZED_COPPER_BARS = BLOCKS.register("horizontal_crossed_oxidized_copper_bars", () -> createOxidizingBarsBlock(WeatheringCopper.WeatherState.OXIDIZED, MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.METAL, BarsType.OXIDIZING));

    public static final DeferredBlock<Block> WAXED_HORIZONTAL_CROSSED_UNAFFECTED_COPPER_BARS = BLOCKS.register("waxed_horizontal_crossed_copper_bars", () -> createMetallicBarsBlock(MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.CROSSED, BarsType.METAL, BarsType.WAXED));
    public static final DeferredBlock<Block> WAXED_HORIZONTAL_CROSSED_EXPOSED_COPPER_BARS = BLOCKS.register("waxed_horizontal_crossed_exposed_copper_bars", () -> createMetallicBarsBlock(MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.CROSSED, BarsType.METAL, BarsType.WAXED));
    public static final DeferredBlock<Block> WAXED_HORIZONTAL_CROSSED_WEATHERED_COPPER_BARS = BLOCKS.register("waxed_horizontal_crossed_weathered_copper_bars", () -> createMetallicBarsBlock(MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.CROSSED, BarsType.METAL, BarsType.WAXED));
    public static final DeferredBlock<Block> WAXED_HORIZONTAL_CROSSED_OXIDIZED_COPPER_BARS = BLOCKS.register("waxed_horizontal_crossed_oxidized_copper_bars", () -> createMetallicBarsBlock(MapColor.METAL, SoundType.COPPER, BarsType.HORIZONTAL, BarsType.CROSSED, BarsType.METAL, BarsType.WAXED));
